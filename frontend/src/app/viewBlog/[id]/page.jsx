        ...
        <div className="max-w-2xl">
                  ...
                  <div>
                    ...
                    <div className="hs-tooltip [--trigger:hover] [--placement:bottom] inline-block">
                      <div className="hs-tooltip-toggle sm:mb-1 block text-start cursor-pointer">
                        <span className="font-semibold text-gray-800 dark:text-neutral-800">
                          {blog.uploadedBy}
                        </span>
                      </div>
                    </div>
                    {/* End Tooltip */}
                    <ul className="text-xs text-gray-500 dark:text-neutral-800">
                      <li className="inline-block relative pe-6 last:pe-0 last-of-type:before:hidden before:absolute before:top-1/2 before:end-2 before:-translate-y-1/2 before:size-1 before:bg-gray-300 before:rounded-full dark:text-neutral-400 dark:before:bg-neutral-800">
                        {blog.createdAt}
                      </li>
                    </ul>
                  </div>
          ...
          <div className="space-y-5 md:space-y-8">
            <div className="space-y-3">
              <h2 className="text-2xl font-bold md:text-3xl dark:text-black">
                {blog.title}
              </h2>
            </div>
            ...
            <p className="text-lg text-gray-800 dark:text-neutral-800">
              {blog.content}
            </p>
