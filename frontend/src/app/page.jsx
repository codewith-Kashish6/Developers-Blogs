    ...
    <>
      ...
      <div className="bg-black text-white py-4 mb-10">
        <div className="max-w-7xl mx-auto text-center">
          <h2 className="text-2xl font-bold md:text-4xl mb-2">Create a Blog</h2>
          <p className="text-sm mb-4">Share your thoughts and ideas with the world!</p>
          <button
            onClick={() => router.push('/create-blog')}
            className="py-2 px-6 border border-white text-white rounded-full bg-transparent hover:bg-white hover:text-black transition duration-300"
          >
            Create New Blog
          </button>
        </div>
      </div>
      {/* End Create Blog Section */}
      ...
      <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        ...
        <div className="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
          <h2 className="text-2xl font-bold md:text-4xl md:leading-tight text-black">
            Crave the tech-keeda in you!
          </h2>
          <p className="mt-1 text-gray-600">
            Discover how innovators are reshaping the tech landscape with groundbreaking tools and strategies.
          </p>
        </div>
        {/* End Title */}
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-10">
          {/* Card 1 */}
          {
            blogList.map(blog => (
              <Link
                key={blog._id}
                className="group flex flex-col h-full border border-black hover:border-transparent hover:shadow-lg focus:outline-none focus:border-transparent focus:shadow-lg transition duration-300 rounded-xl p-5"
              ...
              >
                ...
                <button
                  className="mt-4 py-2 px-4 text-sm font-medium text-white bg-blue-600 rounded-full hover:bg-blue-700"
                  onClick={() => router.push('/viewBlog/' + blog._id)}
                >
                  View Blog
                </button>
              </Link>
        ...
        <div className="mt-12 text-center">
          <a
            className="py-3 px-4 inline-flex items-center gap-x-1 text-sm font-medium rounded-full border border-black bg-transparent text-black hover:bg-gray-100 focus:outline-none focus:bg-gray-100"
            href="#"
          >
            Read more
            <svg
