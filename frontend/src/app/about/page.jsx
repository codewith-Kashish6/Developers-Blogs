...
const About = () => {
    ...
    return (
        <>
            {/* Features */}
            <div className="bg-black text-white min-h-screen px-0 mx-0">
                <div className="max-w-[85rem] mx-auto py-10 sm:py-12 lg:py-14">
                    {/* Updated Heading */}
                    ...
                    <div className="mt-10 lg:mt-16 grid lg:grid-cols-3 gap-8 lg:gap-12">
                        ...
                        <div className="lg:col-span-1">
                            ...
                            We Empower Tech Enthusiasts and Developers
                            </h2>
                            <p className="mt-4 text-gray-300">
                            Beyond sharing insights and trends in the tech world, our platform serves as a hub for developers and tech-savvy individuals to tackle industry challenges through collaboration and shared expertise.
                            </p>
                        </div>
                            ...
                            <div className="grid sm:grid-cols-2 gap-8 md:gap-12">
                                ...
                                <div className="flex gap-x-5">
                                    ...
                                    <div className="grow">
                                        ...
                                        Tech Minds with a Vision
                                        </h3>
                                        <p className="mt-2 text-gray-300">
                                        We curate a community of passionate developers, writers, and tech experts. Their innovation and dedication drive the extraordinary content and discussions on our platform.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="flex gap-x-5">
                                    ...
                                    <div className="grow">
                                        ...
                                        <p className="mt-2 text-gray-300">
                                        From coding tutorials to the latest tech news, we make sure everything you need to stay informed and inspired is just a click away—simple, affordable, and always relevant.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="flex gap-x-5">
                                    ...
                                    <div className="grow">
                                        ...
                                        <p className="mt-2 text-gray-300">
                                        Our detailed articles, how-to guides, and developer-focused resources provide everything you need to level up your tech game and create impactful solutions.
                                        </p>
                                    </div>
                                </div>

                                {/* Building future for people */}
                                <div className="flex gap-x-5">
                                    <svg
                                        className="shrink-0 mt-1 text-blue-500"
                                        xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <div className="grow">
                                        <h3 className="text-xl font-semibold text-white">
                                        Building for the Future of Tech
                                        </h3>
                                        <p className="mt-2 text-gray-300">
                                        We believe in blending functionality with creativity. Our goal is to create a platform where every interaction is as seamless as it is inspiring, designed for those who shape the future.
                                        </p>
                                    </div>
                                </div>
                            </div>
