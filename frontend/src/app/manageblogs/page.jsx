...
const ManageBlog = () => {
    ...
    const updateBlog = (id) => {
        axios.update('http://localhost:5000/blog/update/' + id)
            .then(() => {
    ...
    return (
        <div className="">
            <div className="container mx-auto py-10 mb-20">
                <h1 className="text-center text-2xl font-bold mb-10">Manage Your Blogs</h1>
                ...
                <table className="w-full">
                    ...
                    <tbody>
                        {blogList.map((blog) => (
                            <tr className="border bg-gray-200" key={blog._id}>
                                ...
                                <td className="p-3">{blog.uploadedBy}</td>
                                <td className="p-3">{blog.description}</td>
                                <td className="p-3">{blog.content}</td>
                                <td className="p-3">{new Date(blog.createdAt).toDateString()}</td>
                                <td className="p-3">
                                    <button
                                        onClick={() => deleteBlog(blog._id)}
                                        className="bg-red-500 py-1 px-3 text-white rounded-full"
                                    >
                                        Delete
                                    </button>
                                </td>
                                <td className="p-3">
                                    ...
                                    className="bg-blue-500 py-1 px-3 text-white rounded-full">
                                        Update
                                    </button>
                                </td>
                            </tr>
