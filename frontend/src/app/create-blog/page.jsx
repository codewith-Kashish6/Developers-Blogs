...
const CreateBlog = () => {
  ...
  const uploadFile = (e) => {
    ...
    formData.append('upload_preset', 'mynewpreset');
    formData.append('cloud_name', 'dpsycwiqq');

    axios
      .post('https://api.cloudinary.com/v1_1/dpsycwiqq/image/upload', formData)
      .then((result) => {
        toast.success('File Uploaded Successfully');
        formik.setFieldValue('cover', result.data.url); // Ensure this updates the cover field
      })
      .catch((err) => {
            ...
            <div>
              <div className="mb-4">
                ...
                <MarkdownEditor
                  value={mark}
                  height="410px"
                  onChange={(values, viewUpdates) => setMark(values)}
                />
              </div>
            </div>
